...
std::string find_jvm_library(const std::string& java_home) {
    ...
    std::vector<fs::path> candidates = {
        hp / "lib" / "server" / "libjvm.so",
        hp / "jre" / "lib" / "amd64" / "server" / "libjvm.so",
        hp / "jre" / "lib" / "aarch64" / "server" / "libjvm.so",
        hp / "lib" / "amd64" / "server" / "libjvm.so",
        hp / "lib" / "aarch64" / "server" / "libjvm.so",
        hp / "jre" / "lib" / "server" / "libjvm.so",
        hp / "lib" / "arm" / "server" / "libjvm.so",
        hp / "lib" / "riscv64" / "server" / "libjvm.so",
    };
